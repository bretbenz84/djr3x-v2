...
- Photographic pet memory — tell Rex a pet's name after he asks and he saves its camera crop, then compares future sightings with confirmed photographs. Confident matches get a named greeting; uncertain matches ask. Also supports “remember this chair as Captain's chair” and “do you recognize this chair?” Photos stay in gitignored `data/photo_memory/`. See [photographic memory](docs/photographic_memory.md).
