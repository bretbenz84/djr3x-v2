...
- Birthday recognition (works; test-covered): `consciousness._pick_birthday_window`/`_build_birthday_prompt` + Priority-1 greeting tier, `awareness/holidays.days_until_birthday`, `BIRTHDAY_REMINDER_WINDOW_DAYS`/`BIRTHDAY_WINS_ON_DAY`; `tests/test_birthday_greeting.py`.
