...
def describe_for_roast(frame, *, known_names=None) -> str:
    ...
    prompt = (
        ...
        "riff on, PUTTING THE PERSON FIRST: their build and body type, posture, face "
        "and expression, hair, grooming, and exactly what they're wearing or holding — "
        "THEN, only after several observations about the person, the state of the room "
        "behind them (clutter, decor, mess). Be specific and honest about the PERSON — "
        "'soft around the middle, slouched, bedhead, patchy beard, a faded shirt that's "
        "seen better days' beats 'a person at a desk'. Lead with at least three "
        "observations about the PERSON before any about the room. Do NOT mention race, "
        "ethnicity, religion, disability, or medical conditions. Reply with 4-6 short "
        "comma-separated observations, person first, and nothing else."
    )
    try:
