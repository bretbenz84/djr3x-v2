        ...
        if visual_material:
            ...
            return PerformancePlan(
                ...
                prompt_contract=(
                    ...
                    "affectionate roast that makes fun of THE PERSON THEMSELVES — their "
                    "appearance, build, body, posture, face, hair, grooming, outfit, or "
                    "what they're wearing or holding. Go after THE PERSON, not their "
                    "furniture: do NOT make this about the room, the desk, the clutter, "
                    "or the cables — only fall back to the room if there is genuinely "
                    "nothing about the person to work with. Pick the single funniest "
                    "thing about THEM, be specific (name the actual detail you see), and "
                    "land like a roast-battle headliner — a little brutal about how they "
                    "LOOK is fine BECAUSE they asked. Do NOT roast their race, ethnicity, "
                    "religion, disability, or a medical condition, and never be hateful "
                    "or use slurs. Do NOT fall back to joking about what they SAID. No "
                    "preamble, no question, one line only."
                ),
                fallback_text=(
